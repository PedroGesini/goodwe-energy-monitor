...
### Unidade
| idUnidade | bloco | numero | tipo        | moradores                 |
| --------- | ----- | ------ | ----------- | ------------------------- |
| 1         | A     | 101    | Apartamento | [joão Silva, Maria Souza] |
| 2         | A     | 102    | Apartamento | [Carlos Oliveira]         |
| 3         | B     | 201    | Apartamento | [Ana Costa]               |

### Usuário
| idUsuario | nome            | email                                       | telefone    | status  | cartao | unidade | veiculos |
| --------- | --------------- | ------------------------------------------- | ----------- | ------- | ------ | ------- | -------- |
| 1         | João Silva      | [joao@email.com](mailto:joao@email.com)     | 11999990001 | Ativo   | 1      | 1       | [1]      |
| 2         | Maria Souza     | [maria@email.com](mailto:maria@email.com)   | 11999990002 | Ativo   | 2      | 1       | [2]      |
| 3         | Carlos Oliveira | [carlos@email.com](mailto:carlos@email.com) | 11999990003 | Ativo   | 3      | 2       | [3]      |
| 4         | Ana Costa       | [ana@email.com](mailto:ana@email.com)       | 11999990004 | Inativo | 4      | 3       | [4]      |

### Veículo
| idVeiculo | placa   | modelo       | fabricante | dono |
| --------- | ------- | ------------ | ---------- | ---- |
...
### Sessão de Recarga
| idSessao | inicio           | fim              | energiaKwh | duracaoMin | custo | status       | usuario | veiculo | carregador | tarifa |
| -------- | ---------------- | ---------------- | ---------- | ---------- | ----- | ------------ | ------- | ------- | ---------- | ------ |
...
### Fatura
| idFatura | competencia | valorTotal | dataEmissao | statusPagamento | unidade |
| -------- | ----------- | ---------- | ----------- | --------------- | ------- |
